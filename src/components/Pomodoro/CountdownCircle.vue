...
<div class="countdowncircleborder" :class="isBreak ? 'border-color-blue' : 'border-color-red'">
    <div class="countdowncircle" 
        ...
        <svg @click="toggle()">
            <circle v-show="!isBreak" r="260" cx="272" cy="274" class="animation animation-work" :class=" stop ? 'paused':''"></circle>
            <circle v-show="isBreak" r="260" cx="272" cy="274" class="animation animation-break" :class=" stop ? 'paused':''"></circle>
        </svg>
    </div>
</div>
</template>
